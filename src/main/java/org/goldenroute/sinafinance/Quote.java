...
public class Quote
{
    ...
    public Quote(String content)
    {
        ...
        symbol = items[0];
        name = items[1];
        open = Double.parseDouble(items[2]);
        historyClose = Double.parseDouble(items[3]);
        price = Double.parseDouble(items[4]);
        dayHigh = Double.parseDouble(items[5]);
        dayLow = Double.parseDouble(items[6]);
        bid = Double.parseDouble(items[7]);
        ask = Double.parseDouble(items[8]);
        volume = Double.parseDouble(items[9]);
        turnover = Double.parseDouble(items[10]);
        bidSize1 = Double.parseDouble(items[11]);
        bid1 = Double.parseDouble(items[12]);
        bidSize2 = Double.parseDouble(items[13]);
        bid2 = Double.parseDouble(items[14]);
        bidSize3 = Double.parseDouble(items[15]);
        bid3 = Double.parseDouble(items[16]);
        bidSize4 = Double.parseDouble(items[17]);
        bid4 = Double.parseDouble(items[18]);
        bidSize5 = Double.parseDouble(items[19]);
        bid5 = Double.parseDouble(items[20]);
        askSize1 = Double.parseDouble(items[21]);
        ask1 = Double.parseDouble(items[22]);
        askSize2 = Double.parseDouble(items[23]);
        ask2 = Double.parseDouble(items[24]);
        askSize3 = Double.parseDouble(items[25]);
        ask3 = Double.parseDouble(items[26]);
        askSize4 = Double.parseDouble(items[27]);
        ask4 = Double.parseDouble(items[28]);
        askSize5 = Double.parseDouble(items[29]);
        ask5 = Double.parseDouble(items[30]);
        timestamp = items[31] + " " + items[32];
    }

    @Override
    public String toString()
    {
        return "Quote [symbol=" + symbol + ", name=" + name + ", open=" + open + ", historyClose=" + historyClose
                + ", price=" + price + ", dayHigh=" + dayHigh + ", dayLow=" + dayLow + ", bid=" + bid + ", ask=" + ask
                + ", volume=" + volume + ", turnover=" + turnover + ", bidSize1=" + bidSize1 + ", bid1=" + bid1
                + ", bidSize2=" + bidSize2 + ", bid2=" + bid2 + ", bidSize3=" + bidSize3 + ", bid3=" + bid3
                + ", bidSize4=" + bidSize4 + ", bid4=" + bid4 + ", bidSize5=" + bidSize5 + ", bid5=" + bid5
                + ", askSize1=" + askSize1 + ", ask1=" + ask1 + ", askSize2=" + askSize2 + ", ask2=" + ask2
                + ", askSize3=" + askSize3 + ", ask3=" + ask3 + ", askSize4=" + askSize4 + ", ask4=" + ask4
                + ", askSize5=" + askSize5 + ", ask5=" + ask5 + ", timestamp=" + timestamp + "]";
    }
}
